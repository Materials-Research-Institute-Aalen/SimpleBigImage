...
{
    /// <summary>
    /// An external class which does a graham scan
    /// </summary>
    public class GrahamScan
    {
        public static IList<IntPoint> GrahamScanCompute(IList<IntPoint> initialPoints)
        {
            ...
            var sortQuery = Enumerable.Range(0, initialPoints.Count)
                ...
                .Select((i) => new KeyValuePair<double, IntPoint>(Math.Atan2(initialPoints[i].Y - initialPoints[iMin].Y, initialPoints[i].X - initialPoints[iMin].X), initialPoints[i]))
                .OrderBy((pair) => pair.Key)
                .Select((pair) => pair.Value);
            List<IntPoint> points = new List<IntPoint>(initialPoints.Count);
        ...
        public static bool NearlyEqual(IntPoint a, IntPoint b)
        {
        ...
        static double CCW(IntPoint p1, IntPoint p2, IntPoint p3)
        {
        ...
        static RemovalFlag WhichToRemoveFromBoundary(IntPoint p1, IntPoint p2, IntPoint p3)
        {
